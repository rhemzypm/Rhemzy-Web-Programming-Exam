...
@section('content')
    <div class="bg-blue-900 py-2 px-2">
        <h1 class="text-white text-3xl font-normal">{{ $category->name }}</h1>
    </div>
        ...
        @foreach ($books as $book)
            <div class="flex flex-col w-1/5 border-[1px] border-gray-300 mb-8 mx-5 shadow-md shadow-black">
                ...
                <div class="p-4 space-y-1">
                    ...
                    <button
                        class="w-1/4 bg-blue-900 hover:bg-blue-700 transition-all duration-300 ease-in-out py-2 rounded-lg">
